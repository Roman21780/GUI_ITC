...
class ReportGUI:
    ...
    def clear_excel_file(self):
        """Очищает указанные ячейки в Excel файле"""
        try:
            if not os.path.exists(self.excel_file):
                logging.error(f"Файл не найден: {self.excel_file}")
                messagebox.showerror("Ошибка", f"Файл не найден: {self.excel_file}")
    ...
    def setup_tab1(self):
        ...
        self.insert_button2 = ttk.Button(
            ...
            command=lambda: [self.paste_research_params(), self.change_button_color(self.insert_button2)]
        )
        ...
        self.insert_button2_2 = ttk.Button(
            ...
            command=lambda: [self.paste_research_params_2(), self.change_button_color(self.insert_button2_2)]
        )
    ...
    def change_button_color(self, button):
        """Изменяет цвет кнопки на зеленый."""
    ...
    def setup_bottom_buttons(self):
        ...
        clear_btn = ttk.Button(
            ...
            command=lambda: [self.clear_excel_file(), self.change_button_color(clear_btn)]
        )
    ...
    def paste_data(self, section):
        try:
            ...
            self.paste_data_to_excel(clipboard_data, section)
        except tk.TclError:
    ...
    def paste_research_params(self):
        try:
            ...
            self.insert_button2.config(style="Green.TButton")
